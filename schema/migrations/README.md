...
> **性质**：运行时迁移目录的术语口径说明（非科学 artifact）。解决 spec SSOT 编号 0001-0025 与实际 contiguous 落地 0001-0008 的偏差可见化。
...
**裁决结论**：保留 contiguous 0001-0008 + 诚实映射（本文件即映射 SSOT）。偏差定级 **P2 术语一致性**，非 P0/P1，不阻塞交付。
