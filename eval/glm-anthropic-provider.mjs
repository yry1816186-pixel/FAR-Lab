...
const MODEL_DEFAULT = 'glm-4.6'; // the funded, probe-verified model on this endpoint (glm-5.3 name retired)
  ...
  return {
    ...
    async structuredCall(req, validate) {
      ...
      const body = {
        ...
        // Same live-probed fix as the product transport (2026-08-28): thinking-
        // capable GLM models on this wire think by default and can burn the whole
        // budget on thinking blocks — W4R observed 6/6 baseline calls returning
        // no parseable answer until thinking is explicitly disabled.
