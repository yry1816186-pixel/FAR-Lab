    ...
    if (activeRunId.length === 0) {
      return (
        ...
        >
          ...
          <p className="text-muted-foreground">输入 runId 并点击“查看”以加载研究报告</p>
        </div>
      );
    }
      ...
      return (
        ...
        >
          ...
          <p className="text-muted-foreground">
            报告内容为空（runId: <code className="font-mono text-sm">{activeRunId}</code>）
          </p>
        </div>
      );
    }
    ...
    <div className="space-y-8" data-testid="report-page">
      <header>
        ...
        <p className="mt-1 text-muted-foreground">
          输入 runId 查看研究智能体生成的 HTML 报告（GET /api/v1/report/:runId）
        </p>
      </header>
          ...
          <CardContent className="pt-6">
            ...
            {history.length > 0 && (
              <div className="mt-3 flex flex-wrap items-center gap-1.5">
                <span className="text-xs text-muted-foreground">最近查看：</span>
        ...
        <Card data-testid="report-history-panel">
          <CardHeader>
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-lg">查看历史</CardTitle>
            </div>
            <CardDescription>已查看的 runId 列表</CardDescription>
          </CardHeader>
          <CardContent>
            {history.length === 0 ? (
              <p
        ...
        <Card data-testid="report-verdict-panel">
          <CardHeader>
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-lg">判词摘要</CardTitle>
            </div>
            <CardDescription>
              最近判词（GET /api/v1/verdict）· 共 {verdicts.length} 条
            </CardDescription>
          </CardHeader>
          <CardContent>
            {verdicts.length === 0 ? (
