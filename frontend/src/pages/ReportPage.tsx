    ...
    if (activeRunId.length === 0) {
      return (
        ...
        >
          ...
          <p className="text-muted-foreground">Enter a runId and click “View” to load the research report</p>
        </div>
      );
    }
      ...
      return (
        ...
        >
          ...
          <p className="text-muted-foreground">
            Report content is empty (runId: <code className="font-mono text-sm">{activeRunId}</code>)
          </p>
        </div>
      );
    }
    ...
    return (
      <div data-testid="report-success">
        <div className="mb-2 flex items-center gap-2 text-sm text-muted-foreground">
          <span>
            runId: <code className="font-mono text-foreground">{activeRunId}</code>
          </span>
        </div>
    ...
    <div className="space-y-8" data-testid="report-page">
      <header>
        ...
        <p className="mt-1 text-muted-foreground">
          Enter a runId to view the HTML report generated by the research agent (GET /api/v1/report/:runId)
        </p>
      </header>
      ...
      <section aria-labelledby="report-history-heading" className="grid gap-4 lg:grid-cols-2">
        <h2 id="report-history-heading" className="sr-only">
          View history and verdict summary
        </h2>
        ...
        <Card data-testid="report-history-panel">
          <CardHeader>
            ...
            <CardDescription>List of viewed runIds</CardDescription>
          </CardHeader>
          <CardContent>
            {history.length === 0 ? (
              <p
        ...
        <Card data-testid="report-verdict-panel">
          <CardHeader>
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-lg">Verdict summary</CardTitle>
            </div>
            <CardDescription>
              Recent verdicts (GET /api/v1/verdict) · {verdicts.length} total
            </CardDescription>
          </CardHeader>
          <CardContent>
            {verdicts.length === 0 ? (
