...
GitHub Actions run id: `32105590424`

## Actual command validation

| Check | Command | Exit | Duration | Result |
|---|---|---:|---:|---|
| `build_check` | `pnpm run build:check` | 0 | 30s | **PASS** |
| `frontend_vitest` | `npm --prefix frontend run test` | 1 | 22s | **FAIL** |
| `root_tests` | `pnpm run test` | 1 | 93s | **FAIL** |
| `python_tests` | `pnpm run test:py` | 0 | 2s | **PASS** |
| `ux_gate_tests` | `node --test tests/gates/*.test.ts tests/cli/*.test.ts` | 0 | 16s | **PASS** |
