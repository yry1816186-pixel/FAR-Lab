...
3. `HANDOFF_PROMPT.md` (latest cross-window handoff; supersedes the retired static task plan)
...
started 2026-08-21 from zero product code; construction and evolution state is tracked in
`.control/`.
