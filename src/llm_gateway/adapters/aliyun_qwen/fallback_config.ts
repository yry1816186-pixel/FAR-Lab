/**
 * Competition FallbackChain 链定义（§5 canonical · 05 §8.2）。
 *
 * 链路（3 元素 Qwen-only · §5 · 2026-06 已删 deepseek 第4档·对齐 02 §C2）：
 ...
 *   last_resort（invalidatesD3=true）。§5 已于 2026-06 删 deepseek 第4档
 ...
 *   §5（风险降级 SSOT·更权威）扩展为 3 元素含 qwen-plus 兜底（无 deepseek）。
 *
...
/**
 * Competition profile 降级链（3 元素 Qwen-only · §5）。
