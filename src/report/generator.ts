...
/**
 * CORE-LIMITS-001 · 逐结论限制项：每个非 UNTESTED 裁决节点派生一条确定性
 * 「本结论不能证明什么」。模板按裁决值分支，由 falsificationSpec 具体化（不泛化）。
...
/** CORE-LIMITS-001 覆盖率：非 UNTESTED 节点中被 limitation 覆盖的比例（验收 = 100%）。 */
