...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    code { overflow-wrap: anywhere; word-break: break-word; background: hsl(215, 16%, 95%); padding: 0.125rem 0.375rem; border-radius: 3px; font-family: ui-monospace, SFMono-Regular, monospace; font-size: 0.875em; }
...
<body>
  ...
  <table>
    <caption>Counts by deterministic verdict state</caption>
    <thead><tr><th scope="col">Verdict</th><th scope="col">Count</th></tr></thead>
