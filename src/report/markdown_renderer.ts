...
export function renderMarkdown(
  ...
  // ---- 报告头 ----
  lines.push(`# FAR-Chain Research Report`);
  lines.push('');
  ...
  lines.push(horizontalRule());
  lines.push('');
  lines.push(`*Report auto-generated by the FAR-Chain Report Generator at ${data.generatedAt}*`);
  lines.push('');
...
<body>
  <h1>FAR-Chain Research Report</h1>
  ...
  <footer>
    <p>Report auto-generated by the FAR-Chain Report Generator at ${escapeHtml(data.generatedAt)}</p>
