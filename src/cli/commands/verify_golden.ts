...
const DEFAULT_CASE_DIR = fileURLToPath(new URL('../../../golden_vectors/cases/', import.meta.url));
const DEFAULT_BROWSER_VERIFY_HTML = fileURLToPath(new URL('../../../frontend/public/verify_golden.html', import.meta.url));
