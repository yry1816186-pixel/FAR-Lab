...
// 跨领域共享统计（SSOT 迁移 2026-08-21：pearsonR/pearsonTwoSidedP 移至
// statistics/correlation.ts；此处 re-export 保持历史导入面）。
import { pearsonR, pearsonTwoSidedP } from '../../statistics/correlation.ts';
export { pearsonR, pearsonTwoSidedP };
...
/** Pearson r / two-sided p：见 statistics/correlation.ts（SSOT，上方 re-export）。 */
