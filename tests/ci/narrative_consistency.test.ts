...
test('P0-4: README Known limits count is aligned between EN and zh-CN (SSOT: 12)', () => {
  ...
  assert.equal(enCount, 12, 'EN Known limits SSOT is 12 items (12 = figure-evidence boundary added night-r4)');
});
