...
/** gv-phack-marginal-p-01：primaryAdjustedPValue=0.045 + familySize=5 → MARGINAL_PRIMARY_P (WARN)。 */
 ...
 * 第 22 个 attackId AT-PHACK-MARGINAL-P → 补 gv-phack-marginal-p-01（2026-08-06）。
...
export const GOLDEN_VECTORS: readonly GoldenVectorSpec[] = [
  ...
  // —— gv-phack-marginal-p-01（2026-08-06·补齐第 22 个 attackId·marginal primary-p risk signal）——
  { id: 'gv-phack-marginal-p-01', attackId: 'AT-PHACK-MARGINAL-P', reasonCode: 'MARGINAL_PRIMARY_P', build: gvPhackPcurve01, expectedForcedVerdict: 'INCONCLUSIVE', expectedBlockSeal: false },
