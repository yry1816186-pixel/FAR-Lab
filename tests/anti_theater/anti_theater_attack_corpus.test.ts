 ...
 * 23 attackId）。每个向量 = 干净 base envelope（过全部 23 detector·误报率=0）经单点 mutation 攻击。
 ...
 * D17 + D16 REFUTED 揭示）确定，已由临时探针（已删）对 23 向量实测回填，与 APPENDIX_E §5.2 设计表逐字对齐。
 *
...
test('CI gate 1 · corpus 覆盖全部 23 attackId（无 detector 漏覆盖）', () => {
