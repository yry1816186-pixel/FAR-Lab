    ...
    steps: [
      {
        ...
        failureConditions: ['batch contamination'],
        dependsOn: [],
      },
      {
        id: newId('task'),
        ...
        failureConditions: ['cell venting before cycle 50'],
        dependsOn: [],
      },
      {
        id: newId('task'),
        title: 'estimate growth-rate contrast',
        kind: 'data_analysis',
        inputs: ['spectra series'],
        outputs: ['contrast estimate'],
        method: 'fit the interface contribution per cycle and compare arms',
        failureConditions: ['fit fails to converge'],
        dependsOn: [],
      },
    ],
