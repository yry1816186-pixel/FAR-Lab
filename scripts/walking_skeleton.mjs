...
// 干净重建骨架产物(幂等;不采信缓存;README.md 由脚本重新生成·R6 后不跟踪)
...
// R6 仓库内容政策（2026-08-15）：README.md 由本脚本生成（证据自足·不再 git 跟踪·确定性内容无时间戳）。
writeFileSync(
  join(WS_DIR, "README.md"),
  [
    "# Walking Skeleton — evidence ledger (generated)",
    "",
    "This file is generated by `scripts/walking_skeleton.mjs` (repo-untracked per repo-content policy).",
    "Live evidence: `skeleton_evidence.yaml` (per-step command/exit/duration/layer) and `run_log.txt`.",
    "Artifacts: `demo.far-proof/`, `ask.far-proof/`, `ask.far-proof.rundb`.",
    "",
  ].join("\n"),
  "utf8",
);
