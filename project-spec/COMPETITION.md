...
**Verified:** 2026-08-24 against the official pages (URLs below; previous rechecks 2026-08-22, 2026-08-21). Re-check before any consequential compliance/submission claim; this file is not allowed to override a newer official rule.

**Official sources (recorded 2026-08-22, re-fetched 2026-08-24):**
...
## 0. Model-calling route requirement (verbatim, 2026-08-24 recheck)
...
## Submission requirements (2026-08-24 recheck, summary)

- Materials: 技术方案文档 PDF（研究问题与解决方法、架构设计与讲解、代表性测试案例、源代码、项目工作流程、上下文工程设计、数据或资料来源说明、结果展示与反馈迭代过程）；可附交互前端、可调用测试 API、≤10 分钟演示视频。
  **Page-limit discrepancy (2026-08-24, both official pages re-fetched verbatim):** Aliyun topic page says `技术方案文档（PDF≤30页）`; NADC release says `技术方案文档（PDF≤20页）`. Both pages agree on content items. Per-track 作品提交要求 is the final authority; until it is re-checked, prepare the document to satisfy the **stricter limit (≤20 pages)**.
- Deadline (official fact, recorded as-is, re-confirmed 2026-08-24 on both pages): 作品 2026-09-05 前提交至发榜单位指定链接；压缩包命名"学校-姓名-作品名-联系电话"，附网盘链接/提取码/上传时间截图 + 盖章报名表 PDF。
